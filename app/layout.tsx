  ...
  return (
    <html lang="en">
      <head>
        ...
        {/* Content Security Policy allowing Twitch embed functionality */}
        <meta
          httpEquiv="Content-Security-Policy"
          content="default-src 'self' https://player.twitch.tv https://assets.twitch.tv; script-src 'self' https://player.twitch.tv https://assets.twitch.tv 'unsafe-inline' 'unsafe-eval'; style-src 'self' https://fonts.googleapis.com 'unsafe-inline'; font-src 'self' https://fonts.gstatic.com; img-src 'self' data: https:; connect-src 'self' https://player.twitch.tv https://assets.twitch.tv https://api.twitch.tv wss://pubsub-edge.twitch.tv; frame-src https://player.twitch.tv https:; object-src 'none'; base-uri 'self'; form-action 'self';"
        />
